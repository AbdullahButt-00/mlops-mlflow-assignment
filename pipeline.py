...
def main():
    ...
    with mlflow.start_run(run_name="iris_pipeline_full"):
        try:
            ...
            mlflow.log_artifact(raw_data_path, artifact_path="data/raw")
            ...
            mlflow.log_artifact(train_path, artifact_path="data/processed")
            mlflow.log_artifact(test_path, artifact_path="data/processed")
            ...
            # Log pipeline info as parameters
